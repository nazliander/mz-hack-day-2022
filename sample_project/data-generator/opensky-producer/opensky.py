...
def get_opensky():
    ...
    try:
        # Documentation: https://openskynetwork.github.io/opensky-api/rest.html#all-state-vectors  # noqa
        # Unauthenticated requests are capped to a time resolution of 10 seconds.  # noqa
